 ...
 */
class createReestrOutWithFactoryTest extends TestCase
{
    /**
    ...
    public function testCreateReestr()
    {
        ...
        */
        $this->reader = getReaderFactory::createReader($fileName,
            configLoaderFactory::getConfigLoad($fileName));
        $countRow=1;
        $arr = array();
        // читаем вторую строку с данными (нумерация строк с единицы)
